...
export default function LayoutShell({ children, AIMessage }: Props) {
  return (
    <div className="App">
      <main className="container relative bg-zinc-900 mt-20 rounded-xl border-b-4 border-amber-500 w-full max-w-2xl mx-auto pb-8 text-white py-6  hover:shadow-zinc-950 duration-300 shadow-lg gap-3">
